...
<form name="userForm" action="{{ route('admin.users.store') }}" method="POST">
...
<tr><td></td><td style="text-align: right "><a href="{{ route('admin.users.index') }}" class="btn btn-danger">OK</a> </td></tr>
</table>
</div>
</div>
</div>
...
$.ajax({
type: "DELETE",
url: "http://127.0.0.1:8000/admin/users/"+user_id,
data: {
"id": user_id,
"_token": token,
},
